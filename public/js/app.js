...
window.addEventListener("load", () => {
  loadPosts("recent");
  // Open post from shared URL ?post=ID
  const params = new URLSearchParams(location.search);
  const postId = params.get("post");
  if (postId) {
    setTimeout(() => openPost(postId), 500);
    ...
    <div class="mb pmb">
      ...
      <div class="pm-bd">
        ...
        <div class="pm-acts">
          ...
          <button class="pill" onclick="sharePost('${id}')" style="display:inline-flex;align-items:center;gap:.35rem"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg> Share</button>
...
window.sharePost = async (id) => {
  ...
  const title = document.querySelector(".pm-title")?.textContent || "";
  if (navigator.share) {
    try {
